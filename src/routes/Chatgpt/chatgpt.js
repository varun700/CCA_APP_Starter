...
// import csv1 from "../../../public/data/SKU_details.txt";
// import csv2 from "../../../public/data/SKU_METRICS_V3.txt";
// import csv3 from "../../../public/data/vendor_details.txt";
// import csv4 from "../../../public/data/predicted_capex.txt";
// import csv5 from "../../../public/data/Contract.txt";
// // import csv6 from '../../../public/data/understockdetail.txt';
// // import csv7 from '../../../public/data/overstockdetail.txt';

// import SyntaxHighlighter from "react-syntax-highlighter";
// import { docco } from "react-syntax-highlighter/dist/esm/styles/hljs";
// import { ChatGPTToggle, ChatBot, Chatgptmodalonoroff } from "../../actions";
...
// const apiKey = "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";
...
//   const [speechonoroff, setspeechonoroff] = useState(true);
...
//       );
//     } else {
//       if (chatgptval[0].Model === "gpt-4") {
//         historyMsg.push(
//           { role: "user", content: csv1 },
//           { role: "user", content: csv2 },
//           { role: "user", content: csv3 },
//           { role: "user", content: csv4 },
//           { role: "user", content: csv5 },
...
//             role: "user",
//             content:
//               "Please analyze the above 3 text which you should be referring as tables to answer the following question",
//           },
//           { role: "user", content: filterval }
//         );
//       }
...
//               messages: historyMsg,
//               temperature:
//                 username === "Sundar Kannan" ? chatgptval[0]?.Temperature : 0,
//               model: "gpt-3.5-turbo-16k",
//               stream: true,
...
//           >
//             {" "}
//             <i className="fad fa-robot pr-2"></i> iIMGPT
//           </div>
//         }
//         modalRender={(modal) => (
//           <Draggable
...
//         visible={chatGPT}
//         onCancel={(e) => onclosemodal(e, false)}
//       >
//         <List
//           locale={customLocale}
//           className="demo-loadmore-list mr-3 ml-3 gpt-modal"
